...
_LABEL_RULES: list[tuple[re.Pattern, SemanticType]] = [
    ...
    (re.compile(r"\byears?\b.*(experience|exp)\b|(experience|exp).*\byears?\b", re.I), "years_experience"),
    (re.compile(r"\bsalary\b|compensation\b|expected\b.*(pay|wage|sal)\b|(pay|wage|sal)\b.*expected\b", re.I), "salary_expectation"),
